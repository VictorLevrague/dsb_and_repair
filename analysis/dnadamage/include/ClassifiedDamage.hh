...
//   Defines the type of damage ollowing SDD formalism 
  ...
  int GetDomain() const {return fDomain;};
  ...
  double GetXBarycenter() const {return fX_barycenter;};
  double GetYBarycenter() const {return fY_barycenter;};
  double GetZBarycenter() const {return fZ_barycenter;};
...
private:
  ...
  int fDomain{-1};
  double fX_barycenter{0.};
  double fY_barycenter{0.};
  double fZ_barycenter{0.};
