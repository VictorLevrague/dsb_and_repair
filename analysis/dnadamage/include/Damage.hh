...
*/
  ...
  Damage(DamageType,
          unsigned int pType,
          unsigned int pChromo,
          unsigned int pEvent,
          unsigned long int pCopyNumber,
          unsigned long int pDomain,
          Position,
          DamageCause,
          DamageChromatin);
  ...
  void SetDomain(unsigned int pDomain){fDomain = pDomain;};

  unsigned int GetDomain(){return fDomain;};

  double GetX(){return fPosition.GetX();};
  double GetY(){return fPosition.GetY();};
  double GetZ(){return fPosition.GetZ();};
...
private:
  ...
  unsigned long int fDomain;  // Domain
