...
if __name__ == "__main__":
    ...
    ion_folder = f"output/output{ion_energy}"
    ...
    for copy_nb in range(0, nb_output_folder):
        write_geometry_file(ion_folder + f"/irradiated_geometry_file_{copy_nb}.fab2g4dna", f"/sps/gdrmi2b/levrague/dsb_and_repair/tad_hits/{ion_energy}/tad_hits_{copy_nb}.txt", header, voxels_tad_hc_dict, voxels_tad_ec_dict)
