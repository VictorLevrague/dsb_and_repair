...
public:
    ...
    void WritePhysGeo(G4String pathToOutputs); // modification de la variable d'entree de WritePhysGeo (Mathieu), remplacement de CopyNumber par pathToOutputs 
    void SetFolderName(G4String pathToOutputs); // a modifier pour integrer la variable d'entree (Mathieu)
    G4String GetMyFolderName() {return fPathToOutputs;} // Mathieu
    ...
    time_t GetTimeStart() {return timeStart;};
private:
