...
ChemActionInitialization::ChemActionInitialization(ChemPhysicsList *phys)
: fPhysList(phys)
{
...
{
    SetUserAction(new ChemRunAction());//Mathieu
    ...
    if(chemistryFlag)
    {
        ...
        ChemTimeStepAction* timeStepAction = new ChemTimeStepAction(fPhysList->GetTimeStepModel()); //Mathieu
