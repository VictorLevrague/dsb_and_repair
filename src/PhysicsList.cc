...
// ajout des variables dans le constructeur (Mathieu)
PhysicsList::PhysicsList(const G4String &name, bool per_x, bool per_y, bool per_z, bool ref_walls, bool _activate_pbc) 
...
{   
    ...
    // Ajout de TOUT le contenue de la fonction ConstructProcess depuis G4PeriodicBoundaryPhysics.cc de l'exemple microdosimetry (Mathieu)
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
// Ajout de la fonction PhysicsList::apply_pbc_electrons pris depuis le fichier G4PeriodicBoundaryPhysics.cc (Mathieu)

void PhysicsList::apply_pbc_electrons(auto aParticleIterator, auto pbc_process)
